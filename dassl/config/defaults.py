...
_C.TEST.SPLIT = "test"
# If True and val split exists: after each training phase also evaluate val (ID) then
# test (OOD), e.g. WILDS Camelyon17. Other datasets keep default False.
_C.TEST.REPORT_VAL_AND_TEST = False
